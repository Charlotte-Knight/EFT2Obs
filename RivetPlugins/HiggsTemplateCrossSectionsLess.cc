...
#include "HiggsTemplateCrossSectionsLess.h"  //
...
namespace Rivet {
  ...
  class HiggsTemplateCrossSectionsLess : public Analysis {
  public:
    // Constructor
    HiggsTemplateCrossSectionsLess() : Analysis("HiggsTemplateCrossSectionsLess"), m_HiggsProdMode(HTXS::UNKNOWN) {}
...
*/
    ...
    void init() override {
      printf("==============================================================\n");
      printf("========     HiggsTemplateCrossSectionsLess Initialization     =========\n");
      printf("==============================================================\n");
  ...
  DECLARE_RIVET_PLUGIN(HiggsTemplateCrossSectionsLess);
